...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/res.ListResponse-comment_api_CommentByArticleListResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "comment_api.CommentByArticleListResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "log_stash.LogModel": {
            ...
            "properties": {
                ...
                "level": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/gvb_server_plugins_log_stash_v2.Level"
                        }
                    ]
                },
                "readStatus": {
        ...
        "res.ListResponse-comment_api_CommentByArticleListResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "list": {
                    "$ref": "#/definitions/comment_api.CommentByArticleListResponse"
                }
            }
        },
